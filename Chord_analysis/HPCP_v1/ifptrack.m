...
% This idiom takes the difference between left and right neighbors 
% of each bin i.e. spans of 2 bins.  The idea is that a strong 
% harmonic will dominate the IF of both its upper and lower 
% neighbor, so this value will be small.  See Charpentier 
% ICASSP 1986, http://www.ee.columbia.edu/~dpwe/papers/Charp86-pitchphase.pdf
ddif = [I(2:maxbin, :);I(maxbin,:)] - [I(1,:);I(1:(maxbin-1),:)];

% expected increment per bin = sr/w, or 2sr/w here. 
% Threshold at some small proportion of that
